...
\JLoader::registerNamespace('PlgSystemRegistergoback', __DIR__, false, false, 'psr4');
...
class PlgSystemRegistergoback extends \JPlugin
{
	...
	use PlgSystemRegistergoback\Traits\Helper;
...
$lastLink = \Joomla\CMS\Router\Route::_($linkTreatedAsCurrent);
dumpMessage('onAfterRoute Settings someging :' . $lastLink);
		return true;
	}
	...
	public function onAfterRender()
	{
		...
		$lastLink = \Joomla\CMS\Router\Route::_($lastLink);
dump('onAfterRender');
